...
.section.one{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/01-bg.png);
}
.section.two{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/02-bg.png);
}
.section.three{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/03-bg.png);
}
.section.four{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/04-bg.png);
}
.section.five{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/05-bg.png);
}
.section.six{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/06-bg.png);
}
.section.seven{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/07-bg.png) ;
}
.section.eight{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/08-bg.png);
}
.section.nine{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/09-bg.png) ;
}
.section.ten{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/10-bg.png);
}
.section.eleven{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/11-bg.png) ;
}
.section.twelve{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/12-bg.png);
}
.section.thirteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/13-bg.png) ;
}
.section.fourteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/14-bg.png);
}
.section.fifteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/15-bg.png) ;
}
.section.sixteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/16-bg.png);
}
.section.seventeen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/17-bg.png) ;
}
.section.eighteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/18-bg.png);
}
.section.nineteen{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/19-bg.png) ;
}
.section.twenty{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/20-bg.png);
}
.section.twenty-one{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/21-bg.png);
}
.section.twenty-two{
    background-image: url(<?php echo YITH_YWSBS_ASSETS_URL ?>/images/22-bg.png);
}
...
<div class="landing">
    ...
    <div class="twenty section section-odd clear">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <h2><?php _e( 'Handle personal data requests and anonymisation process','yith-woocommerce-subscription');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'The GDPR introduces important changes to the privacy options. Your store collects data, your customers may want their anonymisations, but you may need to keep this information for as long as the law requires to you as merchant.%3$s%1$sHandle the anonymasation requests%2$s and %1$sthe time customers’ information have to be retained in the subscriptions%2$s from a dedicated panel in the plugin options.','yith-woocommerce-subscription'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_YWSBS_ASSETS_URL ?>/images/20.png" alt="Feature 18" />
            </div>
        </div>
    </div>
    ...
    <div class="twenty-two section section-odd clear">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <h2><?php _e( 'EDIT DETAILS OF ONGOING SUBSCRIPTIONS','yith-woocommerce-subscription');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'Any issues during the subscription, personal problems, change of address or simply any change of mind? If you want to meet your customers half-way, you can now edit the details of ongoing subscriptions: %1$sbilling date, expiry date, billing cycle and amount%2$s.%3$sDiscover more about which features are supported by which payment gateway here ','yith-woocommerce-subscription'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_YWSBS_ASSETS_URL ?>/images/22.png" alt="Feature 22" />
            </div>
        </div>
    </div>
    <div class="section section-cta section-odd">
