...
For more advanced SEO tools and output, check out our free companion plugin [Extension Manager](https://theseoframework.com/extension-manager/).
...
* Optionally, also install the [Extension Manager](https://theseoframework.com/extension-manager/) for additional SEO solutions.
...
For more advanced SEO options and output, we offer the free plugin [Extension Manager](https://theseoframework.com/extension-manager/).
...
Check out our [Extension Manager](https://theseoframework.com/extension-manager/).
